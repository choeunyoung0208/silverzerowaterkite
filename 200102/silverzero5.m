...
%★★★★★f를 반시계방향으로 45도 회전시킨 결과를 g1에할당한 것을 바탕으로 45도만큼 더 회전하면 반시계방향으로 90도 회전된 영상이 출력되지않을까 하는 생각이 들어서
%g8=imrotate(g1,45);명령을 이용하여 회전 가능할거라 생각했는데 오류가 떴습니다. 안되나 봅니다...한번 고민해보겠습니다★★★★★
